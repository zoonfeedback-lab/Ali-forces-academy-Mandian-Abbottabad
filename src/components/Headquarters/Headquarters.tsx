        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="flex flex-col gap-5">
            ...
            <p className="text-[0.95rem] leading-relaxed text-white/60 max-w-lg">
              Nestled in the historical military hub of Pakistan, our main campus provides the ideal environment for rigorous training and discipline. Ali Forces Academy, now Pasban-E-Wattan, serves as a cornerstone for future leaders.
            </p>
          ...
          <div className="relative group">
            <div className="relative rounded-2xl overflow-hidden aspect-[4/3] shadow-[0_32px_80px_rgba(0,0,0,0.5)] border border-gold/20">
              ...
              <div className="absolute bottom-6 left-6 bg-primary/85 backdrop-blur-md border border-gold/30 rounded-xl p-5 pr-8">
                ...
                <span className="block text-[0.7rem] text-gold font-medium tracking-widest mt-0.5 uppercase">Pakistan&apos;s Military Hub</span>
              </div>
            </div>
